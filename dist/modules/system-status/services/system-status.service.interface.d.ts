...
export declare type INodeJsNetworkInterfaceInfo = INodeJsNetworkInterfaceInfoIPv4 | INodeJsNetworkInterfaceInfoIPv6;
...
export interface ISystemInfoResponse {
    cpus: INodeJsCpuInfo[];
    network: {
        [index: string]: INodeJsNetworkInterfaceInfo[];
    };
    os: IOsInformation;
